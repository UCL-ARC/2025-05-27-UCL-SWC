...
address: "B07, 1-19 Torrington Place"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
country: "gb"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes) for the institution that hosts the workshop
language: "en"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) for the workshop
latitude: "51.5220058"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "-0.1337269"       # decimal longitude of the workshop venue (use https://www.latlong.net)
...
instructor: ["Arindam Saha", "Matt Graham", "Paddy Roddy", "Sam Cunliffe"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Arindam Saha", "Matt Graham", "Paddy Roddy", "Sam Cunliffe"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://codimd.carpentries.org/lrm-T98sSlq18SUhiH6nvA  # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
eventbrite:           # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
tickettailor:         # Optional: url bit that points to tickettailor event "1234567/abc/1100"
pretix: ARC/2025-05-28-swc               # Optional: url bit that points to pretix event "organisation/eventid"
